...
function GetUploadify(path,frame,title,dir,num,input,func){
	...
	var iframe_str  = '<iframe frameborder="0" ';
		...
		iframe_str += ' src=\"';
		iframe_str += path+"/?plugin=true&api=Upload&action=view&frame="+frame+"&title="+title+"&dir="+dir+"&num="+num+"&input="+input+"&func="+func;
		iframe_str += '"';

		iframe_str += ' allowtransparency="true" class="uploadframe" scrolling="no">';
		iframe_str += '</iframe>';
...
function GetUploadifysss(path,frame,title,type,dir,num,size,input,func)
{	
	var iframe_str='<iframe frameborder="0" ';
