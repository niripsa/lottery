...
echo $info["title"];
echo "\" style=\"";
echo $info["title_style"];
echo "\"            \r\n             name=\"title\" id=\"title\" onKeyUp=\"return gbcount(this,100,'texttitle');\"  class=\"input-text wid400 bg\">\r\n           <input type=\"hidden\"  value=\"";
echo $title_color;
echo "\"   name=\"title_color\" id=\"title_style_color\"/>\r\n            <input type=\"hidden\" value=\"";
echo $title_bold;
echo "\"  name=\"title_bold\" id=\"title_style_bold\"/>\r\n            <script src=\"";
echo G_GLOBAL_STYLE;
...
echo WEB_PATH;
echo "','uploadify','缩略图上传','photo',50,'picarr')\" style=\"color:#ff0000; padding:10px;\">  <input type=\"button\" class=\"button\" value=\"开始上传\" /></a>\r\n                    </div>\t\t\t\t\t\r\n                    \t<ul id=\"picarr\" class=\"upload-img-list\">\r\n                        ";

foreach ($info["picarr"] as $pic ) {
    echo "                        \r\n                        <li rel=\"";
    echo $pic;
    echo "\"><input class=\"input-text\" type=\"text\" name=\"picarr[]\" value=\"";
    echo $pic;
